...
try:
    ...
    from nltk.probability import (
        FreqDist, MLEProbDist, LaplaceeProbDist, 
        LidstoneProbDist, KneserNeyProbDist
    )
    HAS_NLTK = True
except ImportError:
    HAS_NLTK = False
...
class TestScipyRegression:
    ...
    def test_multinomial_properties(self):
        ...
        freq_counts = dict(zip(categories, sample_counts))
    ...
    def test_dirichlet_prior_properties(self):
        ...
        freq_counts = dict(zip(categories, observed_counts))
...
class TestSklearnRegression:
    ...
    def test_count_vectorizer_compatibility(self):
        ...
        freq_counts = dict(zip(feature_names, total_counts))
...
class TestReferenceDataRegression:
    ...
    def test_brown_corpus_sample_regression(self):
        ...
        brown_sample = {
            ...
            'in': 21341, 'that': 10594, 'is': 10109, 'was': 9815, 'he': 9548,
            'for': 9489, 'it': 8760, 'with': 7289, 'as': 7253, 'his': 6996,
            'on': 6741, 'be': 6377, 'at': 5380, 'by': 5246, 'i': 5201
        }
    ...
    @pytest.mark.parametrize("smoothing_method,params", [
        ("Laplace", {"bins": 100}),
        ("ELE", {"bins": 100}),
