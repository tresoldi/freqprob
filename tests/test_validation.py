...
class TestPerformanceProfiler:
    ...
    def test_profiler_query_performance(self) -> None:
        ...
        freq_dist = {"a": 10, "b": 20, "c": 30}
        method = MLE(freq_dist, logprob=False)
...
class TestValidationSuite:
    ...
    def test_validation_suite_thread_safety(self) -> None:
        ...
        freq_dist = {"a": 10, "b": 20, "c": 30}
        mle_instance = MLE(freq_dist, logprob=False)
        result = suite.validate_thread_safety(mle_instance, freq_dist)
    ...
    def test_validation_suite_run_comprehensive_validation(self) -> None:
        ...
        results = suite.run_comprehensive_validation(method_classes, test_distributions)
...
class TestBenchmarkSuite:
    ...
    def test_benchmark_suite_compare_methods(self) -> None:
        ...
        results = suite.compare_methods(method_configs, freq_dist)
    ...
    def test_benchmark_suite_benchmark_creation_scaling(self) -> None:
        ...
        results = suite.benchmark_creation_scaling(method_classes, vocab_sizes)
    ...
    def test_benchmark_suite_benchmark_query_scaling(self) -> None:
        ...
        freq_dist = {"a": 10, "b": 20, "c": 30}
        methods = {
            "MLE": MLE(freq_dist, logprob=False),
            "Laplace": Laplace(freq_dist, logprob=False),
        }
        query_counts = [2, 4]
...
class TestUtilityFunctions:
    ...
    def test_compare_method_performance(self) -> None:
        ...
        results = compare_method_performance(method_configs, freq_dist)
