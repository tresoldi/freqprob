...
Score Normalization:
-------------------
Original scores range:    [0.000009, 0.000009]
Normalized scores range:  [0.050000, 0.050000]
Normalized scores sum:    1.000000 (should be 1.0)
```
...
LAPLACE:
  ...
  word_009996     (rare    , c=  1): 0.000015
  word_009997     (rare    , c=  1): 0.000015
  word_009998     (rare    , c=  1): 0.000015
  word_009999     (rare    , c=  1): 0.000015
  unseen_word_1   (unseen  , c=  0): 0.000008
  unseen_word_2   (unseen  , c=  0): 0.000008

ELE:
  word_000000     (frequent, c=  1): 0.000013
  word_000001     (frequent, c=  1): 0.000013
  word_000002     (frequent, c=  1): 0.000013
  word_000003     (frequent, c=  1): 0.000013
  word_000004     (frequent, c=  1): 0.000013
  word_009995     (rare    , c=  1): 0.000013
  word_009996     (rare    , c=  1): 0.000013
  word_009997     (rare    , c=  1): 0.000013
  word_009998     (rare    , c=  1): 0.000013
  word_009999     (rare    , c=  1): 0.000013
  unseen_word_1   (unseen  , c=  0): 0.000004
  unseen_word_2   (unseen  , c=  0): 0.000004
...
Time: 0.0098 seconds (should be similar to first time)


Custom Caching Example:
-------------------------
Testing with 500 values (many repeats)...
Time without cache benefit: 0.1177 seconds
Time with cache benefit:    0.0003 seconds
Speedup from caching:      2105.2x
...
Creating models...
Eager MLE creation: 0.0767 seconds
Lazy MLE creation:  0.0001 seconds
Creation speedup: 881.7x

Querying 50 elements...
Eager query time: 0.0001 seconds
Lazy query time:  0.0075 seconds
...
Memory Usage Comparison:
---------------------------
Current process memory:     217.5 MB
Estimated eager model:      4.9 MB (all 50,000 elements)
Estimated lazy model:       0.0 MB (only 50 computed)
Computational efficiency:   0.1% of full computation
Memory efficiency:          ~99.9% savings
```
...
Processing streaming data...
Average update time: 0.144 ms
Maximum update time: 4.232 ms
...
Original memory usage: 2.9 MB

Creating memory-efficient representations...
Compressed creation time:        0.237 seconds
Sparse creation time:            0.012 seconds
Highly compressed creation time: 0.266 seconds

Memory Usage Comparison:
----------------------------
Original Dictionary :    2.9 MB ( +0.0% vs original)
Compressed          :    9.4 MB (-222.9% vs original)
Sparse              :    2.9 MB ( -0.0% vs original)
Highly Compressed   :    9.4 MB (-222.9% vs original)
...
Sparse distribution benefits:
  ...
  Top 10 elements: [('word_018820', np.int64(263352)), ('word_001882', np.int64(165492)), ('word_004869', np.int64(126542))]...
  Elements with count 100-1000: 6

Query Performance Comparison:
-------------------------------
Original    : 0.0002s (5,302,534 queries/sec)
Compressed  : 0.0079s (126,239 queries/sec)
Sparse      : 0.0003s (3,587,942 queries/sec)
...
Profiling: Create MLE Model...
  Memory delta:  -9.67 MB
  Execution time: 0.7056 seconds

Profiling: Create Laplace Model...
  Memory delta:  +0.01 MB
  Execution time: 0.4740 seconds

Profiling: Create Compressed Dist...
  Memory delta:  +0.00 MB
  Execution time: 0.3570 seconds
...
Peak memory usage: 251.6 MB
Memory range: 241.9 - 251.6 MB
...
Memory Savings:
  Compressed: -223.6% savings
    Absolute: -2.2 MB
  Quantized: -221.7% savings
    Absolute: -2.2 MB
  Sparse: -0.0% savings
    Absolute: -0.0 MB
...
MEMORY ALERT: 241.9 MB (threshold: 100.0 MB)
MEMORY ALERT: 241.9 MB (threshold: 100.0 MB)
MEMORY ALERT: 241.9 MB (threshold: 100.0 MB)
MEMORY ALERT: 241.9 MB (threshold: 100.0 MB)
MEMORY ALERT: 241.9 MB (threshold: 100.0 MB)
...
Monitoring duration: 1.81 seconds
Memory statistics:
  min_mb: 241.9 MB
  max_mb: 241.9 MB
  avg_mb: 241.9 MB
...
----------
Model Performance:
  MLE       : 0.0039s creation, 948,938 queries/sec
  Laplace   : 0.0183s creation, 23,228 queries/sec
  Lazy MLE  : 0.0002s creation, 109,971 queries/sec
  Vectorization: 0.2x speedup

Medium (10K):
------------
Model Performance:
  MLE       : 0.0875s creation, 23,619 queries/sec
  Laplace   : 0.2971s creation, 703,742 queries/sec
  Lazy MLE  : 0.0013s creation, 18,247 queries/sec
  Vectorization: 3.8x speedup
  Memory (Compressed): 3.2 MB
  Memory (Sparse): 1.0 MB

Large (50K):
-----------
Model Performance:
  MLE       : 0.2537s creation, 744,992 queries/sec
  Laplace   : 1.4305s creation, 560,736 queries/sec
  Lazy MLE  : 0.0185s creation, 2,735 queries/sec
  Vectorization: 2.3x speedup
  Memory (Compressed): 18.9 MB
  Memory (Sparse): 5.8 MB
...
🎯 CHOOSING THE RIGHT APPROACH:
  ...
  • Medium datasets (10K-100K): Consider vectorization and compression
  • Large datasets (>100K): Use streaming, compression, and lazy evaluation
  • Real-time applications: Streaming models with bounded memory
  • Batch processing: Vectorized operations with memory monitoring
...
🔧 IMPLEMENTATION CHECKLIST:
  ...
  ☐ Validate accuracy vs. efficiency trade-offs
