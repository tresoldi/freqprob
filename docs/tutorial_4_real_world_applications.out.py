...
Test: 'Government announces new policy regarding healthcare reform'
  Best match: technology (score: -207.23)
    technology  : -207.23
    sports      : -207.23
    politics    : -207.23

Test: 'The president discussed artificial intelligence in sports technology'
  Best match: technology (score: -230.26)
    technology  : -230.26
    sports      : -230.26
    politics    : -230.26
...
=========================
Technology: apple announces generation generation generation generation generation generation generation generation generation generation
Sports: the team championships championships championships championships championships championships championships championships championships championships
Politics: government policy court court court court court court court court court court
...
Using best classifier: Unigram + Laplace

Example 1: 'Apple develops new artificial intelligence chip for smartphones'
...
Example 2: 'Basketball players compete in championship finals'
  Predicted: sports
  Scores:
    sports      : -28.16
    technology  : -32.58
...
Example 3: 'Government implements new environmental protection policies'
  Predicted: politics
  Scores:
    politics    : -29.81
    technology  : -32.17
...
Example 4: 'Machine learning algorithms improve medical diagnosis accuracy'
  Predicted: technology
  Scores:
    technology  : -36.74
    sports      : -38.79
...
Query: 'basketball championship'
  1. sports_009 (score: -10.55)
     Basketball team wins championship after intense playoff games throughout season
  2. sports_013 (score: -11.11)
     Hockey players demonstrate exceptional skills during championship playoffs
  3. technology_002 (score: -11.62)
     Microsoft introduces cloud computing solutions for enterprise customers

Query: 'government policy'
  1. politics_016 (score: -11.18)
     Government announces new policies regarding healthcare and education reform
  2. politics_017 (score: -11.18)
     Presidential election campaign focuses on economic issues and foreign policy
  3. technology_002 (score: -11.74)
     Microsoft introduces cloud computing solutions for enterprise customers
...
Analyzing query: 'artificial intelligence technology'
Query tokens: ['artificial', 'intelligence', 'technology']

Term contributions to document scores:

technology_000 (total: -17.52):
  artificial     :  -5.88
  intelligence   :  -5.88
  technology     :  -5.76

technology_001 (total: -17.50):
  artificial     :  -5.87
  intelligence   :  -5.87
  technology     :  -5.76

technology_002 (total: -17.49):
  artificial     :  -5.87
  intelligence   :  -5.87
  technology     :  -5.76

technology_003 (total: -16.98):
  artificial     :  -5.87
  intelligence   :  -5.87
  technology     :  -5.24

technology_004 (total: -16.37):
  artificial     :  -5.31
  intelligence   :  -5.31
  technology     :  -5.76
...
Example 1: 'This movie is absolutely fantastic with brilliant performances'
  Predicted sentiment: positive (confidence: 4.55)
  Scores:
    positive: -29.65
    negative: -34.20
  Top contributing words:
    positive: is(-4.2), absolutely(-4.2), this(-3.7)
    negative: absolutely(-5.3), fantastic(-5.3), brilliant(-5.3)

Example 2: 'The film was disappointing with poor acting and weak story'
  Predicted sentiment: negative (confidence: 5.21)
  Scores:
    negative: -38.14
    positive: -43.35
  Top contributing words:
    positive: the(-5.3), was(-5.3), disappointing(-5.3)
    negative: the(-5.3), was(-5.3), story(-4.2)

Example 3: 'Good cinematography but the plot was confusing and boring'
  Predicted sentiment: negative (confidence: 3.03)
  Scores:
    negative: -40.77
    positive: -43.80
  Top contributing words:
    positive: good(-5.3), but(-5.3), the(-5.3)
    negative: good(-5.3), but(-5.3), the(-5.3)

Example 4: 'Amazing visuals and incredible soundtrack make this film outstanding'
  Predicted sentiment: positive (confidence: 6.19)
  Scores:
    positive: -34.32
    negative: -40.51
  Top contributing words:
    positive: soundtrack(-5.3), visuals(-4.2), make(-4.2)
    negative: amazing(-5.3), visuals(-5.3), incredible(-5.3)
...
1. Apple announces new iPhone with advanced AI capabilities (score: 0.0051)
2. The device features improved camera system and faster processing (score: 0.0044)
3. The smartphone includes innovative design elements and better battery life. (score: 0.0038)
4. Machine learning algorithms enhance user experience through intelligent recommendations (score: 0.0027)
...
• Different domains show varying classification difficulty
• Confidence scores help identify uncertain predictions
• Evaluation metrics depend heavily on application goals

🏗️ IMPLEMENTATION BEST PRACTICES:
===================================

Data Preparation:
• Consistent text preprocessing across train/test
• Handle sentence boundaries appropriately for n-grams
• Consider domain-specific tokenization and normalization
• Balance training data across classes/domains

Model Selection:
• Start with Laplace smoothing as a robust baseline
• Use Kneser-Ney for n-gram language models (n ≥ 2)
• Consider Bayesian smoothing for parameter interpretability
• Tune smoothing parameters using validation data

Feature Engineering:
• Experiment with unigram vs. n-gram features
• Consider term frequency vs. binary feature weighting
• Use probability ratios for comparative tasks
• Normalize scores by sequence length when appropriate

Evaluation Strategy:
• Use held-out test data for final evaluation
• Report both overall and class-wise performance
• Include confidence/uncertainty analysis
• Compare against simple baselines

⚠️ COMMON PITFALLS TO AVOID:
=============================
• Using MLE without smoothing (zero probability problem)
• Inconsistent vocabulary handling across models
• Ignoring the impact of training data size and quality
• Over-tuning hyperparameters on small validation sets
• Forgetting to normalize probabilities when comparing sequences

🚀 SCALING TO PRODUCTION:
==========================
• Use streaming models for real-time applications
• Implement caching for frequently accessed probabilities
• Consider memory-efficient representations for large vocabularies
• Monitor model performance and drift over time
• Plan for vocabulary updates and model retraining
...
📚 FURTHER LEARNING:
====================
• Experiment with different smoothing methods on your data
• Try combining FreqProb with modern neural approaches
• Explore domain adaptation techniques
• Study advanced n-gram models (e.g., class-based, factored)
• Investigate hybrid statistical-neural architectures

✨ FINAL THOUGHTS:
==================
FreqProb provides a solid foundation for probability-based NLP tasks.
While deep learning dominates many applications, classical smoothing
methods remain valuable for:
...
Master these fundamentals, and you'll have a strong foundation
for tackling any NLP challenge! 🎉
```
